...
CREATE INDEX siren_full_siren ON siren_full (siren);
CREATE INDEX siren_full_siret ON siren_full (siret);
CREATE INDEX siren_full_commune ON siren_full (commune);
CREATE INDEX siren_full_tsv ON siren_full USING gin(tsv);
CREATE INDEX siren_full_tsv_nomentreprise ON siren_full USING gin(tsv_nomentreprise);
CREATE INDEX siren_full_tsv_nomprenom ON siren_full USING gin(tsv_nomprenom);
CREATE INDEX siren_full_tsv_enseigne ON siren_full USING gin(tsv_enseigne);
CREATE INDEX siren_full_tsv_adresse ON siren_full USING gin(tsv_adresse);
CREATE INDEX siren_full_nom_raison_sociale ON siren_full USING gin (nom_raison_sociale gin_trgm_ops);
CREATE INDEX siren_full_activite_principale ON siren_full (activite_principale);
CREATE INDEX siren_full_nature_juridique_entreprise ON siren_full (nature_juridique_entreprise);
DROP TABLE siren;
CREATE INDEX siret_tsv ON siret USING gin(tsv);
CREATE INDEX siret_tsv_adresse ON siret USING gin(tsv_adresse);